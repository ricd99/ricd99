...
- I'm currently working on a web app that finds the perfect YouTube channels for you when you're eating solo here (minimal documentation, I will add more soon!): [vids for when you're eating solo](https://github.com/ricd99/ytrec)
